...
-- CreateEnum
CREATE TYPE "ReferralEventType" AS ENUM ('IMPRESSION', 'CLICK', 'INSTALL', 'ORDER_CREATED');
...
CREATE TABLE "ShopSettings" (
    ...
    "discountValue" DECIMAL(5,4) NOT NULL DEFAULT 0.10,
    "expiryDays" INTEGER NOT NULL DEFAULT 2,
    "maxDiscounts" INTEGER NOT NULL DEFAULT 100,
