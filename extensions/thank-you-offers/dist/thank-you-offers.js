...
function z(n2, u3, t3, i3, r3, o3, e3, f3, c3, s3) {
  var a3, h3, p3, y3, _2, m3, b, S2, C3, M2, $2, I2, A2, H2, L, T3 = u3.type;
...
function OfferCard({
  ...
  return _(
      ...
      _(
        ...
        _(
          ...
          logoReady ? _("s-image", {
            ...
            _("s-text", { emphasis: true }, (brand || "?").slice(0, 1).toUpperCase())
          )
        ),
        _(
          "s-stack",
          { gap: "none" },
          _("s-text", { emphasis: true, size: "large" }, brand),
          _("s-text", { size: "small", appearance: "subdued" }, offer)
        )
      )
    ),
    _("s-text", { appearance: "subdued" }, description),
    ...
    cardState === "error" ? _(
      "s-box",
      { padding: "small" },
      _("s-text", { size: "small", appearance: "warning" }, `Error: ${errorMessage || "Failed to load code"}`)
    ) : null,
